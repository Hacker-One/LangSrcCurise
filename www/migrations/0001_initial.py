...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uid', models.AutoField(primary_key=True, serialize=False)),
                ('username', models.CharField(default='test', max_length=100, unique=True, verbose_name='用户账号')),
                ('password', models.CharField(default='test', max_length=100, verbose_name='用户密码')),
                ('userkey', models.CharField(default='123456', max_length=100, verbose_name='用户口令')),
                ('last_login_ip', models.CharField(default='127.0.0.1', max_length=16, verbose_name='最后登陆IP')),
                ('last_login_time', models.DateTimeField(auto_now=True, verbose_name='最后登陆时间')),
                ('privileges', models.CharField(choices=[('yes', '是'), ('no', '否')], default='是', max_length=5, verbose_name='是否拥有添加资产权限')),
